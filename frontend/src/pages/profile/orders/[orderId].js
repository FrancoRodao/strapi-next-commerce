					...
					<Card>
						...
						<div className='content'>
							...
							<p className='content__text'>
								...
								<span className='content__text--strong'>identificador de compra</span>y
								su<span className='content__text--strong'>correo</span>lo puede retirar
						...
						<div className='products'>
							{products?.map((productData) => (
								<p key={productData.id} className='products__text'>
									...
									<span className='content__text--right content__text--price'>
